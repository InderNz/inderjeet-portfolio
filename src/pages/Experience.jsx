export default function Experience() {
  ...
  const pill = (color) => ({
    ...
    borderRadius: '9999px',
    backgroundColor: color === 'teal' ? 'rgba(13,148,136,0.08)' : 'rgba(0,0,0,0.05)',
    color: color === 'teal' ? '#0d9488' : '#78716c',
    border: `1px solid ${color === 'teal' ? 'rgba(13,148,136,0.2)' : 'rgba(0,0,0,0.1)'}`,
  })

  const logoCircle = (initials, color = '#b84a0a') => (
    <div style={{
      width: '48px',
      height: '48px',
      borderRadius: '10px',
  ...
  const metaText = (text) => (
    <span style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.8rem', color: '#a09880', fontWeight: 300 }}>{text}</span>
  )

  const bullet = (items, small = false) => (
    <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', marginTop: '0.75rem' }}>
      {items.map((item, i) => (
        <li key={i} style={{ display: 'flex', gap: '0.65rem', fontFamily: 'DM Sans, sans-serif', fontSize: small ? '0.8rem' : '0.84rem', color: '#78716c', lineHeight: 1.65, fontWeight: 300 }}>
          <span style={{ color: '#b84a0a', flexShrink: 0, marginTop: '0.1rem' }}>·</span>
          {item}
        </li>
      ))}
    </ul>
  ...
  return (
    <div style={{ backgroundColor: '#f0ede6', minHeight: '100vh', paddingTop: '7rem' }}>
      <section style={{ maxWidth: '860px', margin: '0 auto', padding: '0 3rem' }}>
        ...
        <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.62rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#b5a990', marginBottom: '1.5rem' }}>
          Career History
        </p>
        ...
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.95rem', color: '#78716c', fontWeight: 300, marginBottom: '3.5rem', lineHeight: 1.8 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
          ...
          <div style={{ display: 'flex', gap: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '48px', flexShrink: 0 }}>
              {logoCircle('QCS')}
              <div style={{ width: '2px', flex: 1, backgroundColor: 'rgba(194,80,10,0.15)', marginTop: '6px' }} />
            </div>
            ...
            <div style={{ flex: 1, paddingBottom: '2.5rem' }}>
              <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.5rem', marginBottom: '0.2rem' }}>
                <div>
                  <h2 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '1.05rem', fontWeight: 600, color: '#1c1917', marginBottom: '0.1rem' }}>Senior Testing Manager</h2>
              ...
              <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginTop: '0.35rem', marginBottom: '0.85rem' }}>
                ...
                <span style={{ color: '#d4c9bb' }}>·</span>
                {metaText('India · Consultancy')}
              </div>

              <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.84rem', color: '#78716c', lineHeight: 1.75, fontWeight: 300 }}>
              ...
              <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.58rem', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#b5a990', marginTop: '1.75rem', marginBottom: '1rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '36px', flexShrink: 0 }}>
                    {smallLogoCircle('SB')}
                    <div style={{ width: '2px', flex: 1, backgroundColor: 'rgba(13,148,136,0.12)', marginTop: '5px' }} />
                  </div>
                  <div style={{ flex: 1, paddingBottom: '1.5rem' }}>
                    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.5rem' }}>
                      <div>
                        <h3 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.92rem', fontWeight: 600, color: '#1c1917', marginBottom: '0.1rem' }}>Test Architect / Engagement Manager</h3>
                        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.82rem', fontWeight: 500, color: '#44403c' }}>Shawbrook Bank</p>
                      </div>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginTop: '0.3rem', marginBottom: '0.65rem' }}>
                      {metaText('Jan 2019 – Mar 2024')}
                      <span style={{ color: '#d4c9bb' }}>·</span>
                      {metaText('5 Years')}
                    </div>
                    <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.81rem', color: '#78716c', lineHeight: 1.7, fontWeight: 300 }}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                  ...
                  <div style={{ flex: 1, paddingBottom: '1.5rem' }}>
                    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.5rem' }}>
                      <div>
                        <h3 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.92rem', fontWeight: 600, color: '#1c1917', marginBottom: '0.1rem' }}>Test Manager / Architect</h3>
                        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.82rem', fontWeight: 500, color: '#44403c' }}>HAY Bank</p>
                      </div>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                  ...
                  <div style={{ flex: 1, paddingBottom: '0.5rem' }}>
                    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.5rem' }}>
                      <div>
                        <h3 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.92rem', fontWeight: 600, color: '#1c1917', marginBottom: '0.1rem' }}>Test Manager / Architect</h3>
                        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.82rem', fontWeight: 500, color: '#44403c' }}>Waste Management Inc.</p>
                      </div>
          ...
          <div style={{ display: 'flex', gap: '1.25rem' }}>
            ...
            <div style={{ flex: 1, paddingBottom: '2.5rem' }}>
              <h2 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '1.05rem', fontWeight: 600, color: '#1c1917', marginBottom: '0.1rem' }}>Test Analyst</h2>
              <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.88rem', fontWeight: 500, color: '#44403c', marginBottom: '0.35rem' }}>Intel Technologies India Ltd · Netcradle India</p>
          ...
          <div style={{ display: 'flex', gap: '1.25rem' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '48px', flexShrink: 0 }}>
              {logoCircle('KU', '#0d9488')}
            </div>
            <div style={{ flex: 1 }}>
              <p style={{ fontFamily: 'DM Mono, monospace', fontSize: '0.58rem', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#b5a990', marginBottom: '0.75rem' }}>
                Education
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                {[
                  ...
                  <div key={i}>
                    <h3 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.92rem', fontWeight: 600, color: '#1c1917', marginBottom: '0.1rem' }}>{edu.name}</h3>
                    <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.82rem', color: '#44403c', marginBottom: '0.1rem' }}>{edu.school}</p>
                    {metaText(edu.level)}
                  </div>
                ))}
              </div>
